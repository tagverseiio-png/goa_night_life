  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        {/* Stories Row */}
        <div style={{ display: 'flex', gap: '16px', padding: '0 20px 20px 20px', overflowX: 'auto', scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch', width: '100%', boxSizing: 'border-box' }}>
  ...
  return (
    <div style={{ flex: 1, position: 'relative' }}>
      <div style={{ flex: 1, overflowY: 'auto', height: '100%', width: '100%', maxWidth: '100vw', overflowX: 'hidden', boxSizing: 'border-box', paddingBottom: 'calc(84px + env(safe-area-inset-bottom, 20px))' }}>
        ...
        <div style={{ padding: '0 0 20px 20px', boxSizing: 'border-box', width: '100%', overflow: 'hidden' }}>
          <div style={{ fontSize: '16px', color: TOKENS.textPrimary, fontWeight: '500', marginBottom: '16px' }}>Happening This Week</div>
          <div style={{ display: 'flex', gap: '16px', overflowX: 'auto', overflowY: 'hidden', paddingRight: '20px', scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
